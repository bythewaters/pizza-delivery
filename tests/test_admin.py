...
from delivery.models import Customer, FeedBack, Topping, Pizza, PizzaType, Order
...
class DeliveryAdminTests(TestCase):
    ...
    def test_customer_admin_display(self):
    ...
    def test_feedback_admin_display(self):
    ...
    def test_topping_admin_display(self):
    ...
    def test_pizza_admin_display(self):
    ...
    def test_pizza_type_admin_display(self):
        pizza_type = PizzaType.objects.create(type="Test Pizza Type")
        response = self.client.get(
    ...
    def test_order_admin_display(self):
        customer = Customer.objects.create(
            username="testcustomer",
            email="testcustomer@example.com",
            address="123 Main St",
